  ...
  <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
    ...
    >
      ...
      >
        ...
        <el-table-column prop="fund" label="注册资金（元）" width="180" />
        <el-table-column prop="tag" label="商品类别" width="180" />
        <el-table-column prop="address" label="备案地址" width="250"/>
        <el-table-column prop="introduction" label="商店介绍" width="400"/>
